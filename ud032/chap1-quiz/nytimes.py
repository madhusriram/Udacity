...
def article_overview(kind, period):
    ...
    for dic in data:
        if 'section' in dic and 'title' in dic:
            titles.append({dic['section']: dic['title']})
        for mediadic in dic['media']:
            for url_dict in mediadic['media-metadata']:
                if url_dict['format'] == 'Standard Thumbnail':
